...
#' @usage asVPC.binW.CI1(orig.data,sim.data,N.timebin,n.sim,n.hist,
...
#' data(origdata)
#' data(simdata)
#' asVPC.binW.CI1(origdata,simdata,N.timebin=10, n.sim=100,n.hist=3)

asVPC.binW.CI1<-function(orig.data,sim.data,n.sim,
